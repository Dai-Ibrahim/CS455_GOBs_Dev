...
public class DecisonMaker : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        actions[0] = new Action("Go on a hike");
		...
		actions[1] = new Action("Take a nap");
		...
		actions[2] = new Action("Take a bubble bath");
		...
		actions[3] = new Action("Eat sushi");
		...
		actions[4] = new Action("Have a milkshake");
		...
		actions[6] = new Action("Sleep in the bed");
        actions[6].targetGoals.Add(new Goal("Eat", +1f));
        ...
        actions[6].targetGoals.Add(new Goal("Boredom", 0f));
